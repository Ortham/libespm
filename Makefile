OBJECTS =																			Objects/skyrimParserRedoRel.o Objects/commonSupport.o Objects/parser.o Objects/parserClasses.o Objects/viewer.o
OBJECTS2 =																			src/commonSupport.cpp src/parser.cpp src/parserClasses.cpp src/viewer.cpp
TESTOBJ =																			Objects/commonSupport.o Objects/fileFormat.o Objects/test.o
...
Objects/%.o :																		src/%.cpp
																					g++ -c -o $@ $<
Objects/skyrimParserRedoRel.o Objects/commonSupport.o Objects/parser.o Objects/viewer.o :			src/constants.h
Objects/skyrimParserRedoRel.o :															src/commonSupport.h src/parserClasses.h src/viewer.h
Objects/commonSupport.o Objects/viewer.o Objects/test.o Objects/fileFormat.o :							src/commonSupport.h
Objects/parser.o Objects/parserClasses.o :													src/parser.h
